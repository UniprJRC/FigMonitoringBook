...
% plot order
% 'FS','S','MM','LTSr','LTS'
XX=[statpowSMM(:,6) statpowSMM(:,2) statpowSMM(:,3) statpowSMM(:,5) statpowSMM(:,4)];
...
text(5.5,Ylabel-2.5,'S','FontSize',fsize)
text(5.5,Ylabel-3.5,'MM','FontSize',fsize)
text(5.5,Ylabel-4.5,'LTSr','FontSize',fsize)
