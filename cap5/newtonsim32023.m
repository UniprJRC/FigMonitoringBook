...
% else only the scatter plot for different values of lambda
est=1;
...
legend('FS','S','MM','LTS','LTSr','Location','southwest')
xlim([lamx(1,1) lamx(end,1)])
ylabel('Average power','Fontsize',fsizla)
xlabel('\lambda','Fontsize',fsizla)
axes('Position',[.5 .4 0.15 .2])
hold('on')
box on
plot(lamx(:,1),StoFS(:,ij),'LineWidth',2,'LineStyle','-', 'Color',col{5})
plot(lamx(:,1),StoS(:,ij),'LineWidth',LineWidth,'LineStyle','--','Marker','o', 'Color',col{1})
plot(lamx(:,1),StoMM(:,ij),'LineWidth',LineWidth,'LineStyle','-','Marker','v', 'Color',col{2})
plot(lamx(:,1),StoLT(:,ij),'LineWidth',LineWidth,'LineStyle','-.', 'Color',col{3})
plot(lamx(:,1),StoLTr(:,ij),'LineWidth',LineWidth,'LineStyle',':', 'Color',col{4})
...
% hold('on')
% plot(lamx(:,1),biasAA(:,1),'LineWidth',LineWidth,'LineStyle','-')
% plot(lamx(:,1),biasAA(:,2),'LineWidth',LineWidth,'LineStyle','-.')
% plot(lamx(:,1),biasAA(:,3),'LineWidth',LineWidth,'LineStyle',':')
% plot(lamx(:,1),biasAA(:,4),'LineWidth',LineWidth,'LineStyle','--','Marker','o')
% plot(lamx(:,1),biasAA(:,5),'LineWidth',LineWidth,'LineStyle','-','Marker','v')
% 
...
% hold('on')
% box('on')
% plot(lamx(:,1),varAA(:,1),'LineWidth',LineWidth,'LineStyle','-')
% plot(lamx(:,1),varAA(:,2),'LineWidth',LineWidth,'LineStyle','-.')
% plot(lamx(:,1),varAA(:,3),'LineWidth',LineWidth,'LineStyle',':')
% plot(lamx(:,1),varAA(:,4),'LineWidth',LineWidth,'LineStyle','--','Marker','o')
% plot(lamx(:,1),varAA(:,5),'LineWidth',LineWidth,'LineStyle','-','Marker','v')
% 
...
% hold('on')
% box('on')
% plot(lamx(:,1),biasBB(:,1),'LineWidth',LineWidth,'LineStyle','-')
% plot(lamx(:,1),biasBB(:,2),'LineWidth',LineWidth,'LineStyle','-.')
% plot(lamx(:,1),biasBB(:,3),'LineWidth',LineWidth,'LineStyle',':')
% plot(lamx(:,1),biasBB(:,4),'LineWidth',LineWidth,'LineStyle','--','Marker','o')
% plot(lamx(:,1),biasBB(:,5),'LineWidth',LineWidth,'LineStyle','-','Marker','v')
% 
...
% hold('on')
% box('on')
% plot(lamx(:,1),varBB(:,1),'LineWidth',LineWidth,'LineStyle','-')
% plot(lamx(:,1),varBB(:,2),'LineWidth',LineWidth,'LineStyle','-.')
% plot(lamx(:,1),varBB(:,3),'LineWidth',LineWidth,'LineStyle',':')
% plot(lamx(:,1),varBB(:,4),'LineWidth',LineWidth,'LineStyle','--','Marker','o')
% plot(lamx(:,1),varBB(:,5),'LineWidth',LineWidth,'LineStyle','-','Marker','v')
% 
