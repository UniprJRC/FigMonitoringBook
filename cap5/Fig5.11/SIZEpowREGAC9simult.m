...
for nind=1:6
    ...
    StatSIZEsimult(ij,1:6)=[sizevect(ij) SIZ(1,1) SIZ(2,1) SIZ(3,1) SIZ(4,1) SIZ(5,1) SIZ(6,1)];
    StatSIZEindiv(ij,1:6)=[sizevect(ij) SIZ(1,2) SIZ(2,2) SIZ(3,2) SIZ(4,2) SIZ(5,2) SIZ(6,2)];
